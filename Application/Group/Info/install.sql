...
-- 表结构 `ocenter_group`
-- -----------------------------
CREATE TABLE IF NOT EXISTS `haizhi_group` (
...
-- -----------------------------
CREATE TABLE IF NOT EXISTS `haizhi_group_bookmark` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
...
-- -----------------------------
CREATE TABLE IF NOT EXISTS `haizhi_group_dynamic` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------
CREATE TABLE IF NOT EXISTS `haizhi_group_lzl_reply` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `post_id` int(11) NOT NULL,
...
-- -----------------------------
CREATE TABLE IF NOT EXISTS `haizhi_group_member` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `group_id` int(11) NOT NULL,
  `uid` int(11) NOT NULL,
  `status` int(11) NOT NULL,
...
-- -----------------------------
CREATE TABLE IF NOT EXISTS `haizhi_group_notice` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `group_id` int(11) NOT NULL,
...
-- -----------------------------
CREATE TABLE IF NOT EXISTS `haizhi_group_post` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `group_id` int(11) NOT NULL,
  `title` text NOT NULL,
...
-- -----------------------------
CREATE TABLE IF NOT EXISTS `haizhi_group_post_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `group_id` int(11) NOT NULL,
...
-- -----------------------------
CREATE TABLE IF NOT EXISTS `haizhi_group_post_reply` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `post_id` int(11) NOT NULL,
  `parse` int(11) NOT NULL,
...
-- -----------------------------
CREATE TABLE IF NOT EXISTS `haizhi_group_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------
INSERT INTO `haizhi_group_type` VALUES ('1', ' 分类一', '1', '0', '0', '0');
