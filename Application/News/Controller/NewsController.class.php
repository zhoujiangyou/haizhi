    ...
    public function add($id = 0, $pid = 0)
    {
        ...
        if (IS_POST) {
            ...
            $builder->title($title.L('_CATEGORY_'))
                ...
                ->keyRadio('can_post',L('_PLAY_YN_'),'',array(0=>'否',1=>L('_YES_')))->keyDefault('can_post',1)
                ->keyRadio('need_audit',L('_PLAY_YN_AUDIT_'),'',array(0=>'否',1=>L('_YES_')))->keyDefault('need_audit',1)
...
str;
    ...
    public function editNews()
    {
        ...
        if(IS_POST){
            ...
            $data['policylevel']=I('post.policylevel','国家级');
            $data['policyread']=I('post.policyread','否');
            ...
            $builder->title($title.L('_NEWS_'))
                ...
                ->keySelect('policylevel','政策级别','',array('国家级'=>'国家级','省级'=>'省级','地市级'=>'地市级'))
                ->keySelect('policyread','是否政策解读','',array('否'=>'否','是'=>'是'))
                ...
                ->group(L('_BASIS_'),'id,uid,title,cover,content,category,policylevel,policyread')
