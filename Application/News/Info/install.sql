...
-- 表结构 `ocenter_news`
-- -----------------------------
CREATE TABLE IF NOT EXISTS `haizhi_news` (
...
-- -----------------------------
CREATE TABLE IF NOT EXISTS `haizhi_news_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------
CREATE TABLE IF NOT EXISTS `haizhi_news_detail` (
...
-- -----------------------------
INSERT INTO `haizhi_news_category` VALUES ('1', '默认分类', '0', '1', '1', '1', '1');
