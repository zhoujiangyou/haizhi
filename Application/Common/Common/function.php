 ...
 */
function getLou($k) {
    $lou = array(2 => L('_SOFA_'), 3 => L('_BENCH_'), 4 => L('_FLOOR_'));
...
/**
 * 将project中create_time  日期友好转化
 * 将status  转换为 字符  -1:删除 0：待审核发布  1:发布
 * array(
 *   array( project_create_time=>12312313)
 *   array()
 * .............
 * )
 * Date: 2016/3/14
...
function int2time($array) {
    ...
    for ($i = 0; $i < count($array); $i++) {
        $array[$i]['project_create_time'] = date('Y-m-d h:i:s', $array[$i]['project_create_time']);
        switch ($array[$i]['project_status']) {
            case 1;
                $array[$i]['status_text'] = '已发布';
                break;
            case 0;
                $array[$i]['status_text'] = '待审核';
                break;
            case -1;
                $array[$i]['status_text'] = '删除';
                break;
        }
    }
...
function int2time_article($array) {
    ...
    for ($i = 0; $i < count($array); $i++) {
        $array[$i]['create_time'] = date('Y-m-d h:i:s', $array[$i]['create_time']);
            ...
            if ($dur < 3600) {
                ...
                if ($dur < 86400) {
                    ...
                    if ($dur < 259200) {//3天内
                        ...
                        return date('Y年m月d日 ',strtotime($start));
                    }
                }
            }
        }
