...
class IndexController extends Controller{
    ...
    function _initialize()
    {
        ...
        $menu_list['left'][]=array( 'title' => L('_RECENT_'), 'href' => U('News/Index/index'),'tab'=>'home');
        ...
        if($show_edit){
            $menu_list['right'][]=array('tab' => 'create', 'title' => '<i class="icon-edit"></i>'. L('_CONTRIBUTIONS_'), 'href' =>is_login()?U('News/index/edit'):"javascript:location.href='/ucenter/member/login.html'");
